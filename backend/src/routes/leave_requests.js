...
router.post('/', wrapAsync(async (req, res) => {
    ...
    await Leave_requestsService.create(req.body.data, req.currentUser, true, link.host);
    const payload = true;
...
router.put('/:id', wrapAsync(async (req, res) => {
  await Leave_requestsService.update(req.body.data, req.body.id, req.currentUser);
  const payload = true;
  res.status(200).send(payload);
}));
...
router.get('/', wrapAsync(async (req, res) => {
  ...
  const payload = await Leave_requestsDBApi.findAll(
