...
import { create } from '../../stores/leave_requests/leave_requestsSlice'
...
Leave_requestsNew.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default Leave_requestsNew
