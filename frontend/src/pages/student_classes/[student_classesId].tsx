...
const EditStudent_classes = () => {
  ...
  const { student_classesId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: student_classesId }))
  }, [student_classesId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: student_classesId, data }))
...
EditStudent_classes.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default EditStudent_classes
