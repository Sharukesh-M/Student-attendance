...
import { create } from '../../stores/student_classes/student_classesSlice'
...
Student_classesNew.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default Student_classesNew
